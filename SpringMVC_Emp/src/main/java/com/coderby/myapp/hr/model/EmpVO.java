...
public class EmpVO {
	@Min(value=100, message="사원번호는 100 이상이어야합니다.")
	private int employeeId;
	
	@Pattern(regexp="[가-힣a-zA-Z]{1,}", message="이름을 입력하세요.")
	private String firstName;
	
	@Pattern(regexp="[가-힣a-zA-Z]{1,}", message="성을 입력하세요.")
	private String lastName;
	
	@Pattern(regexp="[A-Za-z0-9]{2,}", message="이메일을 입력하세요.")
	...
	@DecimalMax(value="99999" , message="급여는 99999보다 클 수 없습니다.")
	private double salary;
	
//	@Digits(integer=0, fraction=2, message="0이상 1 미만이어야 합니다.")
	@DecimalMin(value="0.00", message="보너스율은 0보다 작을 수 없습니다.")
	@DecimalMax(value="0.99", message="보너스율은 1보다 클 수 없습니다.")
